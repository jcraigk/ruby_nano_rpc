...
module NanoRpc
  # Proxy provides a set of methods for interacting with
  # a Nano resource, such as a node, wallet, or account.
  # The intended use is for inclusion in the NanoRpc wrapper classes.
  module Proxy
    attr_reader :node
